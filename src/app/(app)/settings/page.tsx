        ...
        <TabsContent value="account" className="mt-6 space-y-4">
          <div className="rounded-xl border border-border/80 bg-card/50 p-5 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="email" type="email" defaultValue="alex@marshal.ai" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="occupation">Occupation</Label>
              <Input id="occupation" defaultValue="Product Designer" />
            </div>
          ...
          <div className="rounded-xl border border-border/80 bg-card/50 p-5 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Scholar  |  $16/mo</p>
              </div>
              <Badge>Active</Badge>
            </div>
            <Separator />
